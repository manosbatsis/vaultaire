...
@SupportedAnnotationTypes(
        "com.github.manosbatsis.vaultaire.annotation.VaultaireModelDto",
        "com.github.manosbatsis.vaultaire.annotation.VaultaireModelDtoMixin")
@SupportedSourceVersion(SourceVersion.RELEASE_8)
@SupportedOptions(AnnotationProcessorBase.KAPT_OPTION_NAME_KAPT_KOTLIN_GENERATED)
class VaultaireModelDtoAnnotationProcessor : AbstractVaultaireDtoAnnotationProcessor(
    ...
    override fun getDtoStrategies(annotatedElementInfo: AnnotatedElementInfo): Map<String, ConstructorRefsCompositeDtoStrategy<*, *, *>> {
        ...
        val strategyKeys = listOf(ModelClientDtoStrategy.STRATEGY_KEY)
