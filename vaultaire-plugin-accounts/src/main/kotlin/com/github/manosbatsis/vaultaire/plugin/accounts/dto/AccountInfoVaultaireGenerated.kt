...
/**
 * A [AccountInfo]-specific [StateCordaServiceDelegate]
 */
@CordaService
open class AccountInfoCordaServiceDelegate(
  serviceHub: AppServiceHub
) : AccountsAwareStateCordaServiceDelegate<AccountInfo>(
        serviceHub = serviceHub,
        contractStateType = AccountInfo::class.java)

/**
 * A [AccountInfo]-specific [DefaultExtendedStateService]
 */
@ExtendedStateServiceBean
open class AccountInfoService(
  delegate: AccountsAwareStateServiceDelegate<AccountInfo>
) : ExtendedAccountsAwareStateService<AccountInfo, PersistentAccountInfo, PersistentAccountInfoFields,
        PersistentAccountInfoConditions>(delegate) {
  /**
   * Provides easy access to fields of [PersistentAccountInfo]
   */
  override val fields: PersistentAccountInfoFields = PersistentAccountInfoFields
